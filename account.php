                ...
                <div class="acct-card">
                    ...
                    <?php if (!empty($user['discord_id'])): ?>
                        <div class="connection-row connection-row--linked">
                            ...
                            <form method="post" onsubmit="return confirm('Unlink Discord? You\'ll need to relink before buying anything that grants a Discord role.');">
                                <input type="hidden" name="csrf_token" value="<?php echo e(XyphrosAuth::csrfToken()); ?>">
                    ...
                    <?php else: ?>
                        <div class="connection-row">
                            ...
                            <div style="flex:1;min-width:0;">
                                ...
                                <div class="hint" style="margin:2px 0 0;font-size:12.5px;">Required for Discord-role purchases.</div>
                            </div>
