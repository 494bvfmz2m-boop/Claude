...
function buildOwnerPanelEmbed(client) {
  ...
  return new EmbedBuilder()
    .setTitle('🛠️ Quellum — owner panel')
...
// which older servers won't have until Quellum is re-authorized with the
...
// One embed listing every server Quellum is in, each with member count, open
