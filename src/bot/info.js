...
function buildCommandList({ isOwner, isAdmin, perms, rank, grantedActionKeys }) {
  ...
  const entries = [
    ...
    { name: 'uptime', available: true },
    { name: 'servericon', available: true },
    { name: 'banner', available: true },
    { name: 'afklist', available: true },
    { name: 'pin', available: hasManageMessages },
    { name: 'snipe', available: hasManageMessages },
    { name: 'editsnipe', available: hasManageMessages },
    { name: 'membercount', available: true },
    { name: 'channelinfo', available: true },
    { name: 'invite', available: perms.has(PermissionFlagsBits.CreateInstantInvite) },
    { name: 'steal', available: perms.has(PermissionFlagsBits.ManageGuildExpressions) },
